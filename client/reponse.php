...
<html lang="en">
  ...
  <body>
    <div
      ...
      class="sidenav .bg-danger"
      data-color="white"
      data-mode="side"
      data-hidden="false"
      style="color:#fa9284;    background-color: #2a2424;"
...
<th scope="col">travaille par MR </th>
...
<td>'.$rp['nom'].'</td>
    ...
    print'<h2 style="color: gainsboro;
    position: absolute;
    left: 250px; ">travaille en cours...</h2>';
}
