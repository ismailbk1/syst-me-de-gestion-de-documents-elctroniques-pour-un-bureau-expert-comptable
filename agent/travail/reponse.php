...
$con=connecte();
$requette="INSERT INTO reponse (reponse,demande,agent) VALUES ('$_POST[reponse]','$demande','$_SESSION[id]')";
  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
          <a class="nav-link text-warning" href="travail.php">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2" style="color=white">Reponse 
...
<!-- debut tabele -->
<form action="reponse.php?id=<?php echo $demande?>" method="post" >
<div class="form-outline">
  <textarea class="form-control" name="reponse" id="textAreaExample1" rows="4"></textarea>
  <button type="submit"   class="btn btn-success"  >Envouyer</button>
</div>
</form>
<!-- fin table  -->
    </main>
...
<!-- alert montre lorsque  l'envoi de reponse fait avec success -->
<?php
      ...
      if($alert==1){
       ...
       Swal.fire({
         position: 'center',
         icon: 'success',
         title: 'Reponse Envoyer avec success',
