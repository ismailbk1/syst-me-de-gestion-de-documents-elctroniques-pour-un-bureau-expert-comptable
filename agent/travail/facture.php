  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2" style="color=white">Liste des facture 
...
$i++;
    ...
    <tr>
<th colspan="2" style=" color: red;"><a  class="btn btn-success" href="reponse.php?id=<?php echo $demande?>" >Repondre</a>
 </th>
<td></td>
</tr>
  </tbody>
