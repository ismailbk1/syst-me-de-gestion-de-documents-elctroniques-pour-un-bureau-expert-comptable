    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../travail/travail.php">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Ajout missions</h5>
...
<input type="text" name="nom" required placeholder="donner nom mission" ><br> <br>
<input type="text" name="description" required  placeholder="donner description de mission" ><br><br>
<input type="number" name="prix" required   placeholder="donner prix de mission" >
  </div>
...
$i++;
      ...
      <td>'.$ms['prix'].' dt</td>
      <td>
<a  class="btn btn-success" data-bs-toggle="modal" data-bs-target="#editmodal'.$ms['id'].'" >Modifier</a>
<a onclick="return popUPDeletemission()" href="supprimer.php?id='.$ms['id'].'" class="btn btn-danger" >Supprimer</a>
...
<!-- boucle pour chaque mission on a un modal ki sortie car cahque mission a un unique id  -->
 ...
 <?php 
foreach($mission as $index=> $ms){
  
  ?>

<div class="modal fade" id="editmodal<?php echo $ms['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <div>
  <form action="modifier.php?id=<?php echo $ms['id'] ?>" method="post">

<input type="text" name="nom" required value=" <?php echo $ms['nom'] ?>" ><br> <br>
<input type="text" name="description" required  value="<?php echo $ms['description'] ?>" ><br><br>
<input type="text" name="prix" required  value="<?php echo $ms['prix'] ?>" >
  </div>
      <div class="modal-footer">
